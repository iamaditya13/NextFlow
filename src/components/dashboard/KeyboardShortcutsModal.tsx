...
const shortcutSections = [
  {
    ...
    shortcuts: [
      ...
      { label: 'Multi-select', keys: ['Drag', 'or', 'Shift', 'Click', 'or', 'Ctrl', 'Drag'] },
      { label: 'Pan canvas', keys: ['Space', 'Drag'] },
      { label: 'Cut edges (Scissor)', keys: ['X', 'Drag', 'or', 'Y', 'Drag'] },
      { label: 'Canvas Agent', keys: ['⌘', 'Ctrl', 'C'] },
    ],
  },
  {
    title: 'Node Creation',
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { label: 'Group nodes', keys: ['Ctrl', 'G'] },
      { label: 'Ungroup nodes', keys: ['Ctrl', 'Shift', 'G'] },
    ],
  },
  {
    title: 'Execution',
    shortcuts: [
      { label: 'Run workflow/node', keys: ['Ctrl', 'Enter'] },
    ],
  },
  {
    title: 'View',
