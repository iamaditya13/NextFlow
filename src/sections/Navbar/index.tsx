  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full z-50">
        <header
          className={`relative box-border caret-transparent outline-[oklab(0.556_0_0_/_0.5)] w-full mx-auto px-5 py-4 border-b border-solid md:px-16 transition-all duration-500 ${isDark ? "text-white border-white/15" : "text-neutral-900 border-black/10"}`}
        >
          <div className="items-center box-border caret-transparent grid grid-cols-[repeat(2,minmax(0px,1fr))] outline-[oklab(0.556_0_0_/_0.5)] w-full md:grid-cols-[repeat(3,minmax(0px,1fr))]">
      ...
      {/* Mobile drawer */}
      <div
        className={`fixed top-0 right-0 h-full w-72 bg-black/95 backdrop-blur-xl z-50 transform transition-transform duration-300 ease-out border-l border-white/10 flex flex-col pt-20 pb-8 px-6 md:hidden ${mobileOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        <button
